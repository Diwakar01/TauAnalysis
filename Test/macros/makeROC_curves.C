...
TGraph * getROC(std::vector<TString>discriminators, float xmin = -1, float xmax = -1)
{
  ...
  TFile *file_jet = new TFile(pathToFile+"pfTauIdEffNtupleFromMiniAOD_Fall15_QCD_run2.root");
  ...
  TCut denom_jet("recJetPt > 20. && recJetPt < 1000. && TMath::Abs(recJetEta) < 2.3 && recJetMatch > 0.5 && recJetDeltaR < 0.3 && recTauPt > 18.");
  TCut num_jet = denom_jet && TCut("recTauPt > 20. && TMath::Abs(recTauEta) < 2.3 && recJetMatch > 0.5 && recJetDeltaR < 0.3 && decayModeFinding > 0.5");
...
void plotROC()
{
  ...
  TH1F* histogram_base = new TH1F("histogram_base", "", 60, 0.25, 0.85);
  ...
  */
  ...
  if(sample == "DY"){
    canvas->Print("plots/roc_cut_vs_run2mva_DY_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.png");
    canvas->Print("plots/roc_cut_vs_run2mva_DY_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.pdf");
    canvas->Print("plots/roc_cut_vs_run2mva_DY_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.C");
  }
  else if(sample == "H"){
    canvas->Print("plots/roc_cut_vs_run2mva_GGH_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.png");
    canvas->Print("plots/roc_cut_vs_run2mva_GGH_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.pdf");
    canvas->Print("plots/roc_cut_vs_run2mva_GGH_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.C");
  }
  else if(sample == "Zp1"){
    canvas->Print("plots/roc_cut_vs_run2mva_Zp1_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.png");
    canvas->Print("plots/roc_cut_vs_run2mva_Zp1_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.pdf");
    canvas->Print("plots/roc_cut_vs_run2mva_Zp1_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.C");
  }
  else if(sample == "Zp2"){
    canvas->Print("plots/roc_cut_vs_run2mva_Zp2_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.png");
    canvas->Print("plots/roc_cut_vs_run2mva_Zp2_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.pdf");
    canvas->Print("plots/roc_cut_vs_run2mva_Zp2_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.C");
  }
  else if(sample == "Zp4p5"){
    canvas->Print("plots/roc_cut_vs_run2mva_Zp4p5_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.png");
    canvas->Print("plots/roc_cut_vs_run2mva_Zp4p5_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.pdf");
    canvas->Print("plots/roc_cut_vs_run2mva_Zp4p5_QCD15to3000_deltaRinDenominFR_corrRun2_pt18.C");
  }
