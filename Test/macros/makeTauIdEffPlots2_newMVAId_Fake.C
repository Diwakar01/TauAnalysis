                ...
                const std::string& outputFileName)
{
  ...
  canvas->Update();
  std::string outputFileName_plot = "plots_Sep2016/";
...
//    }
    ...
    if ( recJetPt > 20. && TMath::Abs(recJetEta) < 2.3  && ElectronVetoMatch <= 0){ // && recJetMatch > 0.5 && recJetDeltaR < 0.3 && recTauPt > 18.) { 
...
void makeTauIdEffPlots2_newMVAId_Fake()
{
  ...
  inputFileName_newTauId.Append("pfTauIdEffNtupleFromMiniAOD_Fall15_QCD_run2.root");
